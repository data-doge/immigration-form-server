...
module.exports = {
  ...
  conversionMapFrom: function (commonFieldData) {
    return {
      ...
      'form1[0].#subform[0].Line3_StreetNumberName[0]': commonFieldData.shared_us_mailing_address.street_number_and_name,
      'form1[0].#subform[0].apt_number[0]': commonFieldData.shared_us_mailing_address.apt_number,
      'form1[0].#subform[0].Line3_CityOrTown[0]': commonFieldData.shared_us_mailing_address.town_or_city,
      'form1[0].#subform[0].Line3_State[0]': commonFieldData.shared_us_mailing_address.state,
      'form1[0].#subform[0].Line3_ZipCode[0]': commonFieldData.shared_us_mailing_address.zip_code,
      ...
      'form1[0].#subform[0].place_of_birth[0]': (
        just(commonFieldData.foreign_born_national_place_of_birth.town_or_city.substring(0,21), 22) +
        '             ' +
        commonFieldData.foreign_born_national_place_of_birth.country
      ),
