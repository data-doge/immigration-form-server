module.exports = {
  ...
  conversionMapFrom: function (commonFieldData) {
    return {
      ...
      'F[0].#subform[0].Date_of_Birth[1]': commonFieldData.foreign_born_national_date_of_birth,
      ...
      'F[0].#subform[1].Date_of_Birth[12]': commonFieldData.foreign_born_national_date_of_birth,
